...
INSERT INTO `users` (`id`, `fullname`, `username`, `email`, `password`, `remember_token`, `level`, `alamat`, `foto`, `dompet_id`) VALUES
(1, 'Khoirul Huda', 'huda', 'huda@gmail.com', '$2y$12$bedxw3sxUuaNxGplxaUHD.dq8FRRfof.Ux35lYuJ3WBc/0Mpmp.ym', NULL, 'user', 'Bandung', NULL, 1),
(2, 'Achbar', 'Achbar', 'achbar@gmail.com', '$2y$12$xsak/ThtDeYZQE19NBPineACLVAh1B2T9/H/enLU1sIERlSPa./lG', NULL, 'kurir', 'Semarang', NULL, 2),
(3, 'Michail', 'Michail', 'michail@gmail.com', '$2y$12$DdhaeFU8nHOZC4XHj7qd0.JwYze46R98xGsDvKFhoeC2VAhKnAsS2', NULL, 'admin', 'Jakarta', NULL, 3);
